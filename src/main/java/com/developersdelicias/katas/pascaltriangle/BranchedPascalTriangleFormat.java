	...
	public String format(PascalTriangle triangle) {
		...
		if (triangle.level() == 4) {
			...
			return BLANK.times(6) + level1NodeIterator.next().value() + NEW_LINE +
					BLANK.times(5) + BRANCH_CONNECTOR + NEW_LINE +
					BLANK.times(4) + level2NodeIterator.next().value() + BLANK.times(3) + level2NodeIterator.next().value() + NEW_LINE +
					BLANK.times(3) + BRANCH_CONNECTOR + BLANK.times(1) + BRANCH_CONNECTOR + NEW_LINE +
					...
					BLANK.times(1) + BRANCH_CONNECTOR + BLANK.times(1) + BRANCH_CONNECTOR + BLANK.times(1) + BRANCH_CONNECTOR + NEW_LINE +
